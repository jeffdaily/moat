...
Additional AMD architectures are being brought up and will be added as they are validated.
...
- A few NPP-only entry points: cudaimgproc alphaComp and the 16-bit/4-channel histogram-even and histogram-range variants.
