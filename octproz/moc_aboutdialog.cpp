...
#include <memory>
#include "../projects/OCTproZ/src/octproz_project/octproz/src/aboutdialog.h"
...
QT_MOC_LITERAL(1, 12, 9), // "easterEgg"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "AboutDialog\0easterEgg\0"
};
...
void AboutDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AboutDialog::easterEgg)) {
                *result = 0;
                return;
            }
        }
