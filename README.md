...
<!-- MOAT:TABLE:START -->
Status: ✅ done · 🔧 in progress · 🟡 queued (follower; lead done) · 🔄 re-check (HEAD moved) · ⬜ todo/gated · 🚫 blocked · — n/a. Platforms are gfx90a · gfx1100 · gfx1151. The project name links to upstream, (fork) to our `moat-port` branch.
...
| [pytorch3d](https://github.com/facebookresearch/pytorch3d) ([fork](https://github.com/facebookresearch/pytorch3d/tree/moat-port)) | ✅ · ✅ · ✅ | — |
...
| [popsift](https://github.com/alicevision/popsift) ([fork](https://github.com/jeffdaily/popsift/tree/moat-port)) | ✅ · ✅ · 🔄 | — |
